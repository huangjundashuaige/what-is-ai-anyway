...
var T = 2500;  // 达到所要求精度 -》 2500  自己测试看效果 -》 10
var L = 25;    // 达到所要求精度 -》 25   自己测试看效果 -》 5
var stopping_T = 1e-8;
var fitness = 0;
...
function draw() {
    ...
    for(var i = 0; i < L; i++) {
        // 随机产生一个新解
        var new_solution = two_opt_random(best_solution);
        
        // 计算新解的距离
        var new_solution_distance = calDistance(cities, new_solution);
        console.log("new_solution_distance: ");
        console.log(new_solution_distance);

        // 计算delta
        var delta = new_solution_distance - bestDistance;
        ...
        if(delta < 0) {
            ...
            bestDistance = new_solution_distance;
        }
