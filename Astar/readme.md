...
minimun f_n 8
3 possible moves
open table length 10
minimun f_n 8
3 possible moves
open table length 11
minimun f_n 8
3 possible moves
open table length 12
minimun f_n 8
3 possible moves
open table length 13
minimun f_n 8
3 possible moves
open table length 14
minimun f_n 8
3 possible moves
open table length 15
minimun f_n 9
4 possible moves
open table length 17
minimun f_n 8
2 possible moves
open table length 17
minimun f_n 9
4 possible moves
open table length 19
minimun f_n 8
2 possible moves
open table length 19
minimun f_n 9
4 possible moves
open table length 21
minimun f_n 8
2 possible m
```
2. 比较两种启发函数效率
